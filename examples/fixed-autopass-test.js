/**
 * Test Autopass with proper initialization
 */
...
async function testFixedAutopass() {
  console.log('Testing Autopass with proper bootstrap key...\n')
  
  let pass1 = null
  let pass2 = null
  
  try {
    // Create first Autopass with bootstrap: null (new instance)
    ...
    // The key is to provide bootstrap explicitly as null for new instances
    pass1 = new Autopass(store1, { bootstrap: null })
    await pass1.ready()
...
// Run test
testFixedAutopass().catch(console.error)